        ...
        return [
          {
            ...
            items: menu.filter(
              (item) =>
                item.permission === "create_user" ||
                item.permission === "view_user"
            ),
          },
    ...
    >
      ...
      <div className="border-t border-slate-200 p-3">
        ...
        >
          ...
          <button
            onClick={onLogout}
            className={`mt-3 flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-white hover:text-red-600 ${
              collapsed
                ? "justify-center"
                : "w-full"
            }`}
