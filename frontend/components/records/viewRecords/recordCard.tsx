      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        {role !== "employee" && (
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:shadow-md"
          >
            <FiEdit size={16} />
